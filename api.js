...
var connect = MongoClient.connect(uri, (err, client) => {
  ...
  app.post("/getArtistProfile", (req, res) => {
    ...
    mongo.getArtistProfile(reqb).then(RESB => {
  ...
  app.get("/getItemDetails", (req, res) => {
    ...
    mongo.getItemDetails(itemID).then(resB => {
  ...
  app.post("/getOrders", (req, res) => {
    ...
    mongo.getOrders(reqb).then(RESB => {
  ...
  app.post("/getCart", (req, res) => {
    ...
    mongo.getCart(userID).then(resB => {
  ...
  app.post("/createTransaction", (req, res) => {
    ...
    mongo.createTransation(reqb).then(RESB => {
